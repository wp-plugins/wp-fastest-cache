				    ...
				    <div class="tab1">
						<form method="post" name="wp_manager">
							...
							<div class="questionCon">
								...
								<div class="inputCon"><input type="checkbox" <?php echo $wpFastestCacheMinifyHtml; ?> id="wpFastestCacheMinifyHtml" name="wpFastestCacheMinifyHtml"><label for="wpFastestCacheMinifyHtml">You can decrease the size of html</label></div>
							</div>
							<div class="questionCon">
